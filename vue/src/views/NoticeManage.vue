<template>
  <div class="home" style ="padding: 10px">
    ...
    <!-- 按钮-->
    <div style="margin: 10px 0;" >
      <el-button type="primary" @click = "add" v-if="user.role == 1">发布公告</el-button>
    ...
    <div style="margin: 10px 0">
      ...
      <el-dialog v-model="dialogVisible" title="发布公告" width="30%">
      ...
      <el-dialog v-model="dialogVisible2" title="修改通知信息" width="30%">
        <el-form :model="form" label-width="120px">
